...
if __name__ == "__main__":
    ...
    # user_input = input("Please provide a short story idea. You can specify the genre andcl theme: ")

    # Create the task
    story_task = Task(
        description=dedent(f"Write a short story with the following user input:Create a story about marvel superhero named Heisenbergh with the ability to manipulate probability of happening events."),
        agent=story_master,
    )
